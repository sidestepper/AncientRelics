...
public class BlockAshleafSapling extends BlockBush implements IGrowable
{
    public static final String[] field_149882_a = new String[] {"ashleaf"};
    private static final IIcon[] field_149881_b = new IIcon[field_149882_a.length];
    private static final String __OBFID = "CL_00000305";

    public BlockAshleafSapling()
    {
		setBlockName("AshleafSapling");
		setBlockTextureName(Utilities.MODID + ":sapling");
		setHardness(0.0F);
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = new WorldGenAncient();
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
    ...
    {
        return MathHelper.clamp_int(p_149692_1_ & 7, 0, 0);
    }
