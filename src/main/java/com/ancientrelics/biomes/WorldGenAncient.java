...
public class WorldGenAncient extends WorldGenAbstractTree
{
    //private static final String __OBFID = "CL_00000436";

    public WorldGenAncient()
    {
        super(false);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (IPlantable)AncientRelics.Block_AshleafSapling);
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (k2 = par4 - 3 + l; k2 <= par4 + l; ++k2)
                    {
                        ...
                        for (l2 = par3 - k1; l2 <= par3 + k1; ++l2)
                        {
                            ...
                            for (int i2 = par5 - k1; i2 <= par5 + k1; ++i2)
                            {
                                ...
                                {
                                    this.func_150515_a(par1World, l2, k2, i2, AncientRelics.Block_AshleafLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (k2 = 0; k2 < l; ++k2)
                    {
                        ...
                        {
                            this.func_150515_a(par1World, par3, par4 + k2, par5, AncientRelics.Block_AshleafLog);
                        }
                    }
